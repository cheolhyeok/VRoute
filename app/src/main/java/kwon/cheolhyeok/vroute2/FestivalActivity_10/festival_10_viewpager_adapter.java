...
public class festival_10_viewpager_adapter extends PagerAdapter {


    LayoutInflater inflater;

    public festival_10_viewpager_adapter(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        img.setImageResource(R.drawable.fes10_1+position);

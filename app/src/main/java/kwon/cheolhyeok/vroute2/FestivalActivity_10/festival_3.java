...
public class festival_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        festival_3_viewpager_adapter adapter= new festival_3_viewpager_adapter(getLayoutInflater());

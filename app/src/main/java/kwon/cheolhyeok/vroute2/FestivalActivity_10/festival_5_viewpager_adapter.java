...
public class festival_5_viewpager_adapter extends PagerAdapter {


    LayoutInflater inflater;

    public festival_5_viewpager_adapter(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        img.setImageResource(R.drawable.fes5_1+position);

...
public class festival_6_viewpager_adapter extends PagerAdapter {


    LayoutInflater inflater;

    public festival_6_viewpager_adapter(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        img.setImageResource(R.drawable.fes6_1+position);

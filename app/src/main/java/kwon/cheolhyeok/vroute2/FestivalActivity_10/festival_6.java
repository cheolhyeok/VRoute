...
public class festival_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fes_6); //툴바
        ...
        festival_6_viewpager_adapter adapter= new festival_6_viewpager_adapter(getLayoutInflater());

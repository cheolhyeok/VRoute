...
public class festival_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        festival_7_viewpager_adapter adapter= new festival_7_viewpager_adapter(getLayoutInflater());

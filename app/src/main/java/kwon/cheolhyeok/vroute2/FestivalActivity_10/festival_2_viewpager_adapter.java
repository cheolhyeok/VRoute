...
public class festival_2_viewpager_adapter extends PagerAdapter {


    LayoutInflater inflater;

    public festival_2_viewpager_adapter(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        img.setImageResource(R.drawable.fes2_1+position);

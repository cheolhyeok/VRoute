...
public class festival_1_viewpager_adapter extends PagerAdapter {


    LayoutInflater inflater;

    public festival_1_viewpager_adapter(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        img.setImageResource(R.drawable.fes1_1+position);

...
public class festival_4_viewpager_adapter extends PagerAdapter {


    LayoutInflater inflater;

    public festival_4_viewpager_adapter(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        img.setImageResource(R.drawable.fes4_1+position);

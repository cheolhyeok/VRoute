...
public class festival_8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        festival_8_viewpager_adapter adapter= new festival_8_viewpager_adapter(getLayoutInflater());

...
public class festival_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fes_5); //툴바
        ...
        festival_5_viewpager_adapter adapter= new festival_5_viewpager_adapter(getLayoutInflater());

...
public class festival_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        festival_2_viewpager_adapter adapter= new festival_2_viewpager_adapter(getLayoutInflater());

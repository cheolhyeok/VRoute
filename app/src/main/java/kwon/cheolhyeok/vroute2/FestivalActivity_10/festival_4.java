...
public class festival_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fes_4); //툴바
        ...
        festival_4_viewpager_adapter adapter= new festival_4_viewpager_adapter(getLayoutInflater());

...
public class festival_3_viewpager_adapter extends PagerAdapter {


    LayoutInflater inflater;

    public festival_3_viewpager_adapter(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        img.setImageResource(R.drawable.fes3_1+position);

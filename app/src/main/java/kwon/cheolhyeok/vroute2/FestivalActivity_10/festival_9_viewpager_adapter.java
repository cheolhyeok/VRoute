...
public class festival_9_viewpager_adapter extends PagerAdapter {


    LayoutInflater inflater;

    public festival_9_viewpager_adapter(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        img.setImageResource(R.drawable.fes9_1+position);

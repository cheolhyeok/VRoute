...
public class festival_9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fes_9); //툴바
        ...
        festival_9_viewpager_adapter adapter= new festival_9_viewpager_adapter(getLayoutInflater());

...
import kwon.cheolhyeok.vroute2.MainActivity;
...
public class Search_Route_3 extends AppCompatActivity implements OnMapReadyCallback ,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_route_3);
//
        spots = new HashMap<>();
        handler = new Handler(Looper.getMainLooper());
        positionUpdaterRunnable = new Search_Route_3.PositionUpdaterRunnable();
        handler.post(positionUpdaterRunnable);

        infoWindowContainer = findViewById(R.id.container_popup);
        infoWindowLayoutListener = new Search_Route_3.InfoWindowLayoutListener();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Snackbar.make(view, "3일차 일정을 종료하시겠습니까?", Snackbar.LENGTH_LONG).setAction("OK", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Search_Route_3.this, MainActivity.class);
    ...
    public void onMapReady(final GoogleMap map) {
        ...
        map.addPolyline((new PolylineOptions())
                ...
                .add(new LatLng(35.672238, 139.736412),
                        new LatLng(35.670499, 139.702794),
                        new LatLng(35.705198, 139.649672),
                        new LatLng(35.678132, 139.714994)
                ));

...
import kwon.cheolhyeok.vroute2.PrefManager;
import kwon.cheolhyeok.vroute2.R;
import kwon.cheolhyeok.vroute2.WelcomeActivity2;

import static android.view.View.INVISIBLE;
import static android.view.View.VISIBLE;

public class Search_Route_1 extends AppCompatActivity implements OnMapReadyCallback,View.OnClickListener {

    private static final int POPUP_POSITION_REFRESH_INTERVAL = 16;
    private static final int ANIMATION_DURATION = 500;

    private static final LatLng NaritaAirport = new LatLng(35.777270, 140.382920);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_route_1);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Snackbar.make(view, "1일차 일정을 종료하시겠습니까?", Snackbar.LENGTH_LONG).setAction("OK", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Search_Route_1.this, Search_Route_2.class);
        ...
        findViewById(R.id.tutorial).setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                startActivity(new Intent(Search_Route_1.this, WelcomeActivity2.class));
                finish();
            }
        });
    ...
    public void onMapReady(final GoogleMap map) {
        ...
        map.addPolyline((new PolylineOptions())
                .clickable(true)
                .add(new LatLng(35.777270, 140.382920),
                        new LatLng(35.672238, 139.736412),
                        new LatLng(35.660652, 139.729221),
                        new LatLng(35.615678, 139.777193)
                ));

        CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(NaritaAirport, 16);
